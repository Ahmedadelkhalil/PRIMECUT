...
const Payment = () => {
  ...
  return (
    <div className="paymentPage-container px-4 py-5">
      ...
      <div className="d-flex row">
        <div className="payment-main-leftSide mt-5 col-md-6">
                ...
                <div className="d-flex align-items-center">
                  ...
                  <input
                    ...
                    onBlur={() => {
                      ...
                      dispatch(changeAddress({ addressEdited: editedAddress }));
                    }}
                    onFocus={(e) => {
                      setEditedAddress(e.target.value);
          ...
          <div className="d-flex align-items-center justify-content-between payment-btm-nav mt-4">
            <button>
              <NavLink to="/checkout">return to check out</NavLink>
            </button>
            <button
              onClick={() => {
                handleAlert();
        ...
        <div className="payment-main-rightSide mt-5 px-0 px-md-5 col-md-6">
          ...
          <div className="d-flex justify-content-between align-items-center my-3">
            ...
            <p className="text-capitalize fw-bold main-color-green">{`$${Number(
              Number(total) + 10
            ).toFixed(2)}`}</p>
          </div>
        </div>
      ...
      <Alert
        ref={alertParent}
        msg={`Pay Done Successfuly ${customerInfo.fullName} You'll Be Redirect in ${redirectSeconds}s`}
      />
    </div>
  );
};
